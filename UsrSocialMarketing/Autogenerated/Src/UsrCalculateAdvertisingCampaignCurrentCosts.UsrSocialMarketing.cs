namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAdvertisingCampaignCurrentCostsMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAdvertisingCampaignCurrentCostsMethodsWrapper : ProcessModel
	{

		public UsrCalculateAdvertisingCampaignCurrentCostsMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var typeFilter = esq.CreateFilterWithParameters(FilterComparisonType.Equal, "UsrMrktCampaignIdId", campaignId);
