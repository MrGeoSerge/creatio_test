define("UsrAdvertisingCampaign_ListPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"rootSchemaName": "UsrAdvertisingCampaign",
					"layoutConfig": {
						"width": 328.125
					},
					"classes": [
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"StringAttribute_cve0f85": {
						"modelConfig": {
							"path": "PageParameters.UsrCurrencySetting1"
						}
					},
					"StringAttribute_sergiy": {
						"modelConfig": {
							"path": "PageParameters.UsrCurrencySetting"
						}
					}
				}
			},
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
        		...
        		handler: async (request, next) => {
            		...
            		/* Calculate the value. */
            		const systemCurrency = sysValues.userCulture.displayValue;
					this.console.log("systemCurrency = " + systemCurrency);
            		request.$context.StringAttribute_cve0f85 = systemCurrency;
					request.$context.StringAttribute_sergiy = systemCurrency;
